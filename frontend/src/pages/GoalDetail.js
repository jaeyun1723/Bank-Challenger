    ...
    return (
      <div className="withdrawList">
        <div>
          ...
          <div>
            <small>
              {sessionStorage.getItem("name")}님이 설정한 저축금액이 빠져나가는
              계좌에요.
            </small>
          </div>
          ...
          <div style={{ textAlign: "left" }}>
            ...
            >
              <table style={{ marginRight: "auto" }}>
                <tr>
                  <th rowSpan="2">
                    <span>{bankLogo(withdrawBankName)}</span>
                  </th>
                  <th
                    style={{
                      fontSize: "12px",
    ...
    return (
      <div className="savingList">
        <div>
          ...
          <div>
            <small>
              {sessionStorage.getItem("name")}님이 설정한 저축금액 쌓이는
              계좌에요.
            </small>
          </div>
          <div style={{ marginBottom: "20px" }}></div>
  ...
  return (
    <div style={{ padding: "1em" }}>
      ...
      <div>
        ...
        <div className=" text-primary ml--4 btn btn-link subTitle">규칙</div>
        <div style={{ marginBottom: "5px" }}>
          <small>
            매월 {goalDetail.day === "null" ? "" : goalDetail.day}일{" "}
            {makeComma(goalDetail.savingAmount)}원씩
          </small>
        </div>
        <div className="text-primary ml--4 btn btn-link subTitle">
          입금 내역
